...
with tab1:
    render_tab(all_players, "hr_score", "HR Score", "hr_reasons", "Top 15 HR Candidates Today", 15)

with tab2:
    render_tab(all_players, "hit_score", "Hit Score", "hit_reasons", "Top 15 Hit Candidates Today", 15)

with tab3:
    render_tab(all_players, "xbh_score", "XBH Score", "hr_reasons", "Top 15 XBH Candidates Today", 15)

with tab4:
    render_tab(all_players, "dbl_score", "Double Score", "hit_reasons", "Top 15 Double Candidates Today", 15)

with tab5:
    render_tab(all_players, "tb_score", "Total Bases Score", "hr_reasons", "Top 15 Total Bases Candidates Today", 15)
