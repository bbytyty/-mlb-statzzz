...
def render_tab(players, score_key, score_label, reasons_key, title):
    top = filtered_sorted(players, score_key, 10)
    if not top:
...
with tab1:
    render_tab(all_players, "hr_score", "HR Score", "hr_reasons", "Top 10 HR Candidates Today")

with tab2:
    render_tab(all_players, "hit_score", "Hit Score", "hit_reasons", "Top 10 Hit Candidates Today")

with tab3:
    render_tab(all_players, "xbh_score", "XBH Score", "hr_reasons", "Top 10 XBH Candidates Today")

with tab4:
    render_tab(all_players, "dbl_score", "Double Score", "hit_reasons", "Top 10 Double Candidates Today")

with tab5:
    render_tab(all_players, "tb_score", "Total Bases Score", "hr_reasons", "Top 15 Total Bases Candidates Today")
